...
$(document).ready(function(){
	$.ajax({
		...
		success: function(data) {
			...
			for (var i in data){
				var columnLabel = (data[i].school)? data[i].school + " : " + data[i].total : 'Null' + " : " + data[i].total;
				column.push(columnLabel);
				doughnutCols.push((data[i].school)? data[i].school : 'Null');
				total.push(data[i].total);
			}
			var labelTable = 'No of students per school';
