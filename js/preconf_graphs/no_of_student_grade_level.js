...
$(document).ready(function(){
	$.ajax({
		...
		success: function(data) {
			...
			for (var i in data){
				var columnLabel = (data[i].level)? data[i].level + " : " + data[i].total : 'Null' + " : " + data[i].total;
				column.push(columnLabel);
				doughnutCols.push((data[i].level)? data[i].level : 'Null');
				total.push(data[i].total);
			}
			var labelTable = 'No of students per level';
