...
$(document).ready(function(){
	$.ajax({
		...
		success: function(data) {
			...
			for (var i in data){
				var columnLabel = (data[i].gender)? data[i].gender + " : " + data[i].total : 'Null' + " : " + data[i].total;
				column.push(columnLabel);
				doughnutCols.push((data[i].gender)? data[i].gender : 'Null');
				total.push(data[i].total);
			}
			var labelTable = 'No of Schools per gender';
