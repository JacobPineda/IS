...
$(document).ready(function(){
	$.ajax({
		...
		success: function(data) {
			...
			for (var i in data){
				var columnLabel = (data[i].region)? data[i].region + " : " + data[i].total : 'Null' + " : " + data[i].total;
				column.push(columnLabel);
				doughnutCols.push((data[i].region)? data[i].region : 'Null');
				total.push(data[i].total);
			}
			var labelTable = 'No of Schools per Region';
