...
$(document).ready(function(){
	$.ajax({
		...
		success: function(data) {
			...
			for (var i in data){
				var columnLabel = (data[i].generic_name)? data[i].generic_name + " : " + data[i].total : 'Null' + " : " + data[i].total;
				column.push(columnLabel);
				doughnutCols.push((data[i].generic_name)? data[i].generic_name : 'Null');
				total.push(data[i].total);
			}
			var labelTable = 'No of Generic Names';
